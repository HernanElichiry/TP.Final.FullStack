      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        ...
        <div className="form-group">
          ...
          <Controller
            ...
            defaultValue=""
            rules={{
              required: "La descripción es requerida.", maxLength: { value: 250, message: "La descripción no puede superar los 250 caracteres." },
              minLength: { value: 100, message: "La descripción debe contener al menos 100 caracteres." }
            }}
        ...
        <div className="form-group">
          ...
          <Controller
            ...
            control={control}
            defaultValue=""
            rules={{ required: "La duración es requerida.", min: { value: 1, message: "La duracion debe ser un numero positivo." } }}
        ...
        <div className="form-group">
          ...
          <Controller
            ...
            rules={{
              ...
              validate: (file) => file && file.size <= 5 * 1024 * 1024 || "La imagen no debe exceder los 5MB."
            }}
            render={({ field }) => (
              <input
                type="file"
        ...
        <div className="form-group">
          ...
          <Controller
            ...
            control={control}
            defaultValue={""}
            rules={{ required: "El video Presentacion es requerido.", validate: (url) => isYouTubeUrl(url) || "Por favor, ingresa un URL válido de YouTube." }}
            render={({ field }) => (
              <input
                type="text"
